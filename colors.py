...
_HELP_TEXT = {
    "de": (
        ...
        "• !abo all → Start- & Fertig-Meldungen für **alles** abonnieren, auch für jeden "
        "künftigen Druck (egal ob von mir, aus Studio oder von wem anderem); !abo stop beendet's\n"
        "• !abo 2 3 → nur bestimmte Nummern aus !liste (einmalig); !abo stop 2 nimmt eine wieder raus\n"
    ...
    "en": (
        ...
        "• !abo all → subscribe to start & done notifications for **everything**, future prints "
        "included (mine, Studio's, anyone's); !abo stop ends it\n"
        "• !abo 2 3 → only specific numbers from !list (one-off); !abo stop 2 removes one again\n"
