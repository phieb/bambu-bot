...
_HELP_TEXT = {
    "de": (
        ...
        "!deabo bestellt ab\n"
        "• !abo immer → Dauer-Abo: ich meld dir automatisch jeden neuen Druck (auch aus Studio); "
        "!abo stop immer schaltet's ab\n"
    ...
    "en": (
        ...
        "!deabo unsubscribes\n"
        "• !abo immer → standing subscription: I report every new print automatically (Studio too); "
        "!abo stop immer turns it off\n"
